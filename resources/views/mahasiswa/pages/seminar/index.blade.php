...
@section('content')
    <div class="flex-1 p-6">
        <h1 class="text-3xl font-bold mb-6">Seminar</h1>
        ...
        <div>
            ...
            <div class="grid grid-cols-3 gap-4">
                @for ($i = 0; $i < 3; $i++)
                    <a href="{{ route('mahasiswa.seminar.detail', ['id' => $i]) }}"
        ...
        <!-- Seminar Yang Sedang Berjalan -->
        <div class="mt-8">
            <h2 class="text-xl font-semibold mb-4">Seminar Yang Sedang Berjalan</h2>
            <div class="grid grid-cols-3 gap-4">
                @for ($i = 0; $i < 3; $i++)
                    <a href="{{ route('mahasiswa.seminar.detail', ['id' => $i]) }}"
                        class="block bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition">
        ...
        <!-- Pagination seminar yang sedang berjalan -->
        <div class="mt-6 flex justify-center items-center space-x-2">
            <span class="bg-green-600 text-white px-2 py-1 rounded-full">1</span>
            <a href="#" class="text-gray-700 px-2 py-1">2</a>
            <a href="#" class="text-gray-700 px-2 py-1">3</a>
